namespace BretonniaInGameKitbashDataCompiler {
    ...
    export namespace CommonUserInterface {
        ...
        const logger = new Logger("BretonniaInGameKitbashDataCompiler CommonUserInterface")

        /** Destroy one or more components */
        export function Destroy(...components: IUIComponent[]) {
            const name = `Destroy_BretonniaInGameKitbashDataCompiler_${RandomString(5)}`
        ...
        export class MessageBox implements IPopupDialog {
            ...
            readonly identifier = `MessageBox_BretonniaInGameKitbashDataCompiler_${RandomString(5)}`
