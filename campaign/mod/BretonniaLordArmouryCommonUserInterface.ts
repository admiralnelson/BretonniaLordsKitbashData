namespace BretonniaLordArmoury {
    ...
    export namespace CommonUserInterface {
        ...
        const logger = new Logger("BretonniaLordArmoury CommonUserInterface")
         ...
         */
        export function GetLocalisedString(stringId: string): string {
            return common.get_localised_string(stringId)
        }

        /** Destroy one or more components */
        export function Destroy(...components: IUIComponent[]) {
            const name = `Destroy_BretonniaLordArmoury_${RandomString(5)}`
        ...
        export class MessageBox implements IPopupDialog {
            ...
            readonly identifier = `MessageBox_BretonniaLordArmoury_${RandomString(5)}`
